...
## 💻 **4. Frontend Snippets (HTML, CSS, Sass, SCSS, JS)**
...
## 🚀 **5. Backend Snippets (Node.js & Express.js)**
...
│   └── readme.md
├── javascript snippet/
│   ├── javascript_snippets.json
│   └── readme.md
├── nodejs & expressjs snippet/
│   ├── nodejs_expressjs_snippets.json
│   └── readme.md
├── react js snippet/
│   ├── react_snippets.json
│   └── readme.md
├── react native snippet/
│   ├── react_native_snippets.json
│   └── readme.md
├── sass_scss snippet/
│   ├── sass_snippets.json
│   └── readme.md
│
├── custom_usersetting for vscode/
│   ├── settings.json
│   └── readme.md
│
└── README.md
...
Replace with `userSettings.json` from this repo.

Restart VSCode for full effect.
...
Feel free to contribute snippets, improvements, issues or enhancements.
PRs are welcome!
